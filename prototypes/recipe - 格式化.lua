    ...
    },
    {
        ...
        results =
        {
          ...
          },--0.290666666666666
          {
            ...
            amount = 1,
            probability = 0.4,
          },--0.4000000000000000000000000000001
          {
            type = "item",
            name = "yumako",
            amount = 1,
            probability = 0.681,
          },--0.6814814814814814814815
          {
            type = "item",
            name = "sulfur",
            amount = 1,
          ...
          },--0.6
          {
            ...
            amount = 1,
            probability = 0.678,
          },--0.6777777777777777777777777777
          {
            type = "item",
            name = "holmium-ore",
            amount = 1,
            probability = 0.553,
          },--0.5536000000000000000000000000000000001
          {
            type = "item",
            name = "jellynut",
            amount = 1,
            probability = 0.874,
          },--0.8740740740740740740740
          {
            type = "item",
            name = "calcite",
            amount = 1,
            probability = 0.976,
          },--0.9760000000000000000000001
          {
            type = "item",
            name = "stone",
            amount = 1,
            probability = 0.277,
          },--0.276800000000000001
          {
            type = "item",
            name = "ice",
            amount = 4,
          ...
          },--0.699555555555555
          {
            ...
            amount = 1,
            probability = 0.034,
          },--0.03377777777777777777777777777
          {
            type = "fluid",
            name = "ammoniacal-solution",
            amount = 1,
      ...
      {
        {
            type = "item",
            name = "uranium-235",
            amount = 400, ignored_by_stats = 400,
        },
        {
            type = "item",
            name = "uranium-238",
            amount = 50, ignored_by_stats = 20}
        },
      results =
        {
        {
            type = "item",
            name = "uranium-235",
            amount = 410, ignored_by_stats = 400, ignored_by_productivity = 400,
        },
        {
            type = "item",
            name = "uranium-238",
            amount = 20, ignored_by_stats = 20, ignored_by_productivity = 20}
        },
    },
    {
